        ...
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <h3 className="text-2xl py-2 dark:text-white md:text-3xl">
              Developer (Blockchain, Web, App) and designer (UI/UX), DevOps Engineer, and Data Scientist.
            </h3>
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
              Freelancer providing services for programming, CI/CD pipeline, blockchain, and design content needs. Join me down below and let's get cracking!
            </p>
